...
function ObjectRuntimePageToolbar({ tenantId, objectTypeKey }) {

  return (

    <div className="portal-object-runtime-header__page-toolbar page-toolbar-actions__group">
  ...
  if (shouldRenderMenuInActiveTab && !shouldRenderObjectIdentity) {
    ...
    return (
      ...
      >
        ...
        <ObjectRuntimePageToolbar tenantId={tenantId} objectTypeKey={objectTypeKey} />
