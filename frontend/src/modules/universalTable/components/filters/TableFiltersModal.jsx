      ...
      <div style={bodyStyle}>
        {!hasColumns && (
          <div style={emptyStateStyle}>
            Колонки ещё не загружены. Закрой окно и открой
            фильтры повторно.
          </div>
        )}
        ...
        <div style={nameAndDefaultLineStyle}>
          <label style={filterNameShortLineStyle}>
            <span style={fieldLabelInlineStyle}>
              Название
            </span>
        ...
        <div style={sectionHeaderStyle}>
          ...
          {!isExternalEditMode &&
            normalizedSavedFilters.length > 0 && (
              <select
        ...
        <div style={conditionsTableHeaderStyle}>
          <div style={conditionHeaderTextStyle}>
            Поле
          </div>
