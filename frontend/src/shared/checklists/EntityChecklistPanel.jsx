...
/**
 * Shared checklist panel (Universal Tables + Object Platform parity).
 */
export default function EntityChecklistPanel({
  entityType,
  entityId,
  onCountChange = null,
}) {
  ...
  return (
    <div style={wrapperStyle}>
      ...
      {isLoading ? <div style={emptyStyle}>Загрузка...</div> : null}
        ...
        {items.map((item) => (
          ...
          >
            ...
            <input
              ...
              onBlur={(event) => handleUpdateTitle(item, event.target.value)}
              onKeyDown={(event) => {
                if (event.key === "Enter") {
