#!/usr/bin/env python3
"""Record Action Engine tabs milestone in istoriya and napravleniya plan tree."""
...
DIRECTION_TITLE = 'Создать раздел "Действия"'
STEP_TITLE = 'Добавлены вкладки «Действия» и «Правила»'
STATUS_DONE_LABEL = "Готово"
STATUS_NOT_STARTED_LABEL = "Не начато"

HISTORY_TITLE = 'Добавлены вкладки «Действия» и «Правила»'
HISTORY_DESCRIPTION = (
    "В Studio → Object Type добавлены системные вкладки «Действия» (/actions) "
    "и «Правила» (/rules) с заглушками ObjectActionsTab / ObjectRulesTab."
)
HISTORY_RESULT = (
    "Инфраструктура навигации для Action Engine и Rule Engine; CRUD и runtime не реализованы."
)
...
def main() -> int:
    ...
    try:
        ...
        if direction_id is None:
            print(f"ERROR: direction '{DIRECTION_TITLE}' not found", file=sys.stderr)
            return 1
