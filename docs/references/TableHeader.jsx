...
import TableColumnMenu from "../settings/TableColumnMenu";
import TableFieldsVisibilityPanel from "../settings/TableFieldsVisibilityPanel";
...
function canMoveColumn(column, columns = [], isEditMode) {
  ...
  if (isPrimaryDataColumn(column, columns)) {
    return false;
  }
...
export default function TableHeader({
  ...
  const resolvedFullTableMinWidth =
    typeof fullTableMinWidth === "number"
      ? `${fullTableMinWidth}px`
      : fullTableMinWidth;
  ...
  return (
    <div
      ...
      style={{
        ...
        width: "fit-content",
        minWidth: resolvedFullTableMinWidth || "100%",
        maxWidth: "none",
    ...
    >
      {showSelectionColumn && (
        ...
        >
          <input
            ...
            ref={(el) => {
              if (el) {
                el.indeterminate = Boolean(someRowsSelected);
              }
            }}
      ...
      {columns.map((column) => {
        ...
        const isMenuOpen =
          String(openedColumnMenuId) === columnId && Boolean(editingColumnDraft);
          ...
          >
            ...
            <span
              ...
              onClick={(event) => {
                ...
                if (!isColumnEditable || !canEditColumns) {
                  return;
                }
      ...
      <TableFieldsVisibilityPanel
        ...
        panelRectSettings={fieldsPanelRectSettings}
        onPanelRectSettingsChange={onFieldsPanelRectSettingsChange}
      />
    </div>
  );
}